		...
		$('#listBookModal').on('show.bs.modal', function (event) {
			...
			.done(function(json) {
				...
				$.each(json, function(key, value){
					$('#booktable').html("");
					html+="<tbody><tr><td>  <a  id=\" showbooksubmit \" href=\" # \" >"+value['bookName']+"</a> </td>  <td> <a href=\" # \" >Update</a> | <a href=\" # \" >Delete</a>  </td> </tr></tbody>";
					console.log(' array content is '+value['bookName']+" " +value['bookCategory']);
					category = value['bookCategory'];
					console.log("Category is: "+category);
				})
				console.log("Category is: "+category);
				modal.find('.modal-title').text(category+'.');//category found in from shown books
